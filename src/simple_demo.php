...
//给单个帐号下发通知
var_dump(XingeApp::PushAccountAndroid(10000, "secretKey", "account", "title", "content"));
//给所有设备下发通知
...
//开发环境下 给单个帐号下发通知
var_dump(XingeApp::PushAccountIos(10000, "secretKey", "account", "title", "content", [], XingeApp::IOSENV_DEV));
//开发环境下 给所有设备下发通知
var_dump(XingeApp::PushAllIos(10000, "secretKey", "title", "content", [], XingeApp::IOSENV_DEV));
//开发环境下 给标签选中设备下发通知
